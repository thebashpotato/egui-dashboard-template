//! Implementation of a color scheme.

use super::traits::CustomTheme;

use eframe::egui;
use eframe::egui::{epaint, style, Color32, Rounding};
...
impl CustomTheme for Catppuccin {
...
/// Prebuilt theme for Frappe colorscheme
...
/// Prebuilt theme for Mocha colorscheme
